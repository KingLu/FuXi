...
def prefictint(imageRawData):
        ...
        with tf.Session() as sess:
                ...
                imageRawData = tf.cast(imageRawData, tf.float32)
...
def getImageRawData(imagename):
        imageRawData = imread(imagename, mode='L')
        imageRawData = np.invert(imageRawData)
        imageRawData = imresize(imageRawData, (28, 28))
        #imshow(imageRawData)
        #imageRawData = imageRawData.reshape(1, 28, 28, 1)
        return imageRawData
...
def main(argv):
        ...
        #imageRawData = getImageRawData(argv)
